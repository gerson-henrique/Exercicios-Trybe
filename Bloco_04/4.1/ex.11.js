/* Uma pessoa que trabalha de carteira assinada no Brasil tem descontados de seu salário bruto o INSS e
 o IR. Faça um programa que, dado um salário bruto, calcule o líquido a ser recebido.
...
if( salarioBase >= 1903.33 && salarioBase <=2826.65){
...
//De R$ 2.826,66 a R$ 3.751,05: alíquota de 15% e parcela de R$ 354,80 a deduzir do imposto
    ...
    parcela=354.80;
//De R$ 3.751,06 a R$ 4.664,68: alíquota de 22,5% e parcela de R$ 636,13 a deduzir do imposto
    }else if( salarioBase >= 3751.05 && salarioBase <=4.664,68){
...
if(salarioBase<1903.33){
    salarioLiquido=salarioBase;
}else{
    salarioLiquido= (salarioBase + parcela) - (salarioBase*impostoDeRenda) ;
}
